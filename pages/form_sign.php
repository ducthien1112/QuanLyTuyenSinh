...
function check_time()
{
    ...
    $sql_start_date = "select thoi_gian from thoi_gian where su_kien = 'Mở cổng đăng kí dự thi'";
    $sql_end_date = "select thoi_gian from thoi_gian where su_kien = 'Đóng cổng đăng kí dự thi'";
    $start_date = mysqli_query($conn, $sql_start_date);
    $end_date = mysqli_query($conn, $sql_end_date);
...
//        echo "$hoten, $gioitinh, $monchuyen, $dantoc, $hokhau, $ngaysinh, $noisinh, $sdt, $truong_thcs";
    ...
    } else if (check_valid($hoten, $sdt, $ngaysinh)) {
        $loi = "Hồ sơ đã tồn tại !!!";
    } else if (check_time()) {
        $loi = "Đã quá thời gian đăng kí dự thi !!";
    } else {
...
<head>
    ...
    <title>
        ĐĂNG KÍ DỰ THI TUYỂN SINH LỚP 10
    </title>
                                        ...
                                        <form action="#" style="width: 600px" class="border-2 m-auto p-2" method="post"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="nam"
                                                           name="gioitinh" value="1">
                                                    <label class="form-check-label" for="nam">Nam</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="nu" name="gioitinh"
                                                           value="2">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-select-sm p-2"
                                                        aria-label=".form-select-sm example" name="monchuyen"
                                                        id="monchuyen">
                                            ...
                                            <button type="submit" class="btn btn-primary p-2 " id="btndangky"
                                                    name="btndangky">Đăng ký
                                            </button>
                                        </form>
