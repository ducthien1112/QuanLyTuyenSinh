...
function check_valid($name, $phone_number)
{
    global $conn;
    $sql = "select count (*) from ho_so where ten = '$name' and phone = '$phone_number' ";
...
if (isset($_POST['tra cuu'])) {
    if ($_POST['name'] != "" && $_POST['phone'] != "" && check_valid($_POST['name'],$_POST['phone'])) {
        // show dùm tôi cái ảnh này lên với
        $qr_code = 'https://img.vietqr.io/image/970423-89816092001-G3pavAY.jpg?accountName=NGUYEN%20DINH%20HIEU&
        amount=100000&addInfo='.$_POST['name'].'+'.$_POST['phone'];
    }
    else{
        echo '<div class="alert alert-success">Không tồn tại hồ sơ</div>';
    }
}
...
<li><a href="/diem-thi.aspx" title="Tra cứu điểm thi">Tra cứu điểm thi</a></li>
                            ...
                            <tr>
                                <td class="bg-head2" bgcolor="#f0ffff">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <form method="post" action="">
                                                <td class="bg-t3">
                                                    <a>Họ và tên </a><input type="text" name="name">
                                                    <a>Số điện thoại </a><input type="number" name="phone">
                                    ...
                                    <tr>
                                        <form method="post" action="">
                                            <td class="bg-t3">
                                                <a>Họ và tên </a><input type="text" name="name">
                                                <a>Số điện thoại </a><input type="number" name="phone">
                                                <input type="submit" value="Tra cứu" name="tra cuu">
                                            </td>
                                        </form>
